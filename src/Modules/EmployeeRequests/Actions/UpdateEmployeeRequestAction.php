...
class UpdateEmployeeRequestAction
{
    ...
    public function handle(Request $request, EmployeeRequest $employeeRequest): EmployeeRequest
    {
        $data = $this->validator->validate($request);

        return $this->service->update($employeeRequest, $data);
    }
}
